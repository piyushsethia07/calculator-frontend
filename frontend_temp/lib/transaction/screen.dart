...
import 'package:frontend_temp/transaction/service.dart';
                      ...
                      Row(
                        children: [
                          ...
                          Expanded(
                            flex: 2,
                            child: Icon(
                              transaction.cashInOut == 'In'
                                  ? Icons.arrow_downward
                                  : Icons.arrow_upward,
                              color: transaction.cashInOut == 'In'
                                  ? Colors.green
                                  : Colors.red,
                            ),
                          ),
                              ...
                              children: [
                                ...
                                Text(
                                  ...
                                  style: TextStyle(
                                      fontSize: 14,
                                      color: Colors
                                          .grey), // Adjust font size and color as needed
                                ),
                              ],
                            ),
                          ),
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () => showDialog(
          ...
          builder: (BuildContext context) =>
              AddTransactionDialog(onSubmit: (Transaction transaction) {
