...
import 'package:frontend/transaction/model.dart'; // Ensure this import points to your Transaction model

class AddTransactionDialog extends StatelessWidget {
  final Function(Transaction) onSubmit;

  const AddTransactionDialog({Key? key, required this.onSubmit}) : super(key: key);
  @override
